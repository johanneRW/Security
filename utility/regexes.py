...
USER_FIRST_NAME_REGEX = f"^[A-ZÆØÅ][a-zA-ZæøåÆØÅ-]{{{USER_FIRST_NAME_MIN},{USER_FIRST_NAME_MAX}}}$"


USER_LAST_NAME_MIN = 2
USER_LAST_NAME_MAX = 22
USER_LAST_NAME_REGEX = f"^[A-ZÆØÅ][a-zA-ZæøåÆØÅ-]{{{USER_LAST_NAME_MIN},{USER_LAST_NAME_MAX}}}$"
